...
public class MiddleEastPropertiesStrategy extends ContinentStrategy implements ICountrySpecificProperties {

    private static final BigDecimal SALLARY_INDEX = new BigDecimal("0.50");
    private static final int HEIGHT_INDEX = 9;

    public MiddleEastPropertiesStrategy() {
